...
public:
    ...
    void MC(double J = 0, double h = 0, int nSimulation = 0, long int steps_to_equilibrium = 400000000, long int mc_steps = 50000000000000, bool radius = false);
    //void MC(  double J=0, double h=0, int nSimulation = 0, long int steps_to_equilibrium = 100000, long int mc_steps = 1000000000, bool radius = false);
