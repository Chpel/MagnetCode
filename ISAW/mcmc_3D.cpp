...
void Protein::MC(double J_in, double h_in, int Simulation, long int steps_to_equilibrium, long int mc_steps, bool bradius)
{
    ...
    std::uniform_int_distribution<long int> distribution_spin(0, lattice.lattice_side * lattice.lattice_side * lattice.lattice_side - 1);
...
void Protein::write_file(long int i) {
    ...
    filename = "Geometry_ISAW_3D_" + std::to_string(J) + "_" + std::to_string(h) + "_" + std::to_string(number_of_monomers) + ".txt";
